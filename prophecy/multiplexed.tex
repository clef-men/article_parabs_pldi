...
They handle the case when a single prophet is used to make independent predictions, as in \cref{sec:chaselev}.
The corresponding reasoning rules are in \cref{fig:prophecy_multiplexed}.
