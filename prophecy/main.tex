...
To verify the Chase-Lev work-stealing deque (see \cref{sec:chaselev}), we needed to introduce two additional layers, presented in \cref{sec:prophecy_wise,sec:prophecy_multiplexed}.

\input{prophecy/primitive}

\input{prophecy/typed}

\input{prophecy/wise}

\input{prophecy/multiplexed}
