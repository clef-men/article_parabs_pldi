...
For technical reasons, \Iris specifications involve the \emph{later modality} ($\iLater \iProp$)~\citep{DBLP:journals/jfp/JungKJBBD18}, the \emph{big later modality} ($\iBiglater \iProp$) and \emph{later credits} ($\iCredit{n}$)~\citep{DBLP:journals/pacmpl/SpiesGTJKBD22}.
They can be safely ignored at first reading.
The later and the big later modalities can be eliminated in one step of computation.
