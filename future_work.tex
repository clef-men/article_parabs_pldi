...
With functors, we could make the \Parabs library completely modular.
With exceptions, we could catch and re-raise exceptions in \ocamlinline{Pool}.
With algebraic effects, we could implement \ocamlinline{wait} without using the call stack, and implement \emph{continuation stealing} for \ocamlinline{async}.
