...
With exceptions, we could catch and re-raise exceptions in \ocamlinline{Pool} and \ocamlinline{Vertex}.
With algebraic effects, we could get rid of evaluation contexts in \ocamlinline{Pool} and use continuation-stealing.
