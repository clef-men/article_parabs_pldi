...
The idea of work-stealing is illustrated in \cref{fig:chaselev_work_stealing}. Each domain owns a deque-like data structure, called \emph{work-stealing deque}, to store its tasks.
