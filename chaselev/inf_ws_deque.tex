...
The persistent assertion $\inv\ t\ \iIname$ represents the knowledge that $t$ is a valid deque.
...
(3) a back index reserved to the owner of the deque.
...
The last part, beyond the back index, corresponds to the private section of the array, reserved to the owner.
