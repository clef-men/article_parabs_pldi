...
In practice, these weaker specifications, especially that of \c{pop}, are not sufficient to reason about the \emph{completion} of a work-stealing scheduler: once the scheduler terminates, we know that all submitted tasks have finished.
