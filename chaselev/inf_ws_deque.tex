...
In practice, these weaker specifications, especially that of \c{pop}, are not sufficient to reason about the \emph{completion} of a work-stealing scheduler, \ie showing that all submitted tasks were executed after the scheduler terminates.
