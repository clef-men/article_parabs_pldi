...
Essentially, the library is made of four abstraction levels built on top of each other: \ocamlinline{Ws_deques}, \ocamlinline{Ws_hub}, \ocamlinline{Pool} and \ocamlinline{Vertex}.
...
Remarkably, the three upper levels implemented on top of \ocamlinline{Ws_deques} should be \OCaml functors.
