...
\begin{mathparpagebreakable}
    \iPersistent{(\inv\ \v{pool}\ t\ \iPredTwo\ \iPredFour)}
  \and
    \iPersistent{(\obligation\ \v{pool}\ \iProp)}
  \and
  ...
  \and
    \iSpec[
      ...
      \l{pool.context}\ \v{pool}\ \v{ctx}\ \v{scope} \iSep \\
      \inv\ \v{pool}\ t_1\ \iPredTwo_1\ \iPredFour_1 \iSep \\
      \begin{inboxIndent}
      ...
      \l{pool.context}\ \v{pool}\ \v{ctx}\ \v{scope} \iSep \\
      \inv\ \v{pool}\ t_2\ \iPredTwo_2\ \iPredFour_2 \iSep \\
